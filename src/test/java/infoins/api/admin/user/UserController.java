...
public class UserController extends BaseClass {
    ...
    public void createValidTest() throws IOException {
        ...
        given()
                ...
                .body(getGeneratedString("create-user-valid.json"))
                .when()
                .post(createEndPoint)
                .then()
    ...
    public void createInvalidDataType1Test() throws IOException {
        ...
        given()
                ...
                .header("authorization", getBearerToken())
                .contentType(ContentType.JSON)
                .body(getGeneratedString("create-user-datatpe1-invalid.json"))
                .when()
                .post(createEndPoint)
                .then()
    ...
    public void createInvalidDataType2Test() throws IOException {
        ...
        given()
                ...
                .header("authorization", getBearerToken())
                .contentType(ContentType.JSON)
                .body(getGeneratedString("create-user-datatpe2-invalid.json"))
                .when()
                .post(createEndPoint)
                .then()
                .assertThat().statusCode(400)
    ...
    public void modifyValidTest() throws IOException {
        ...
        given()
                ...
                .header("authorization", getBearerToken())
                .contentType(ContentType.JSON)
                .body(getGeneratedString("modify-user-valid.json"))
                .when()
                .put(modifyEndPoint)
                .then()
                .assertThat().statusCode(201);
    ...
    public void modifyInvalidDataTpe1Test() throws IOException {
        ...
        given()
                ...
                .header("authorization", getBearerToken())
                .contentType(ContentType.JSON)
                .body(getGeneratedString("modify-user-datatpe1-invalid.json"))
                .when()
                .put(modifyEndPoint)
                .then()
                .assertThat().statusCode(400)
    ...
    public void modifyInvalidDataTpe2Test() throws IOException {
        ...
        given()
                ...
                .header("authorization", getBearerToken())
                .contentType(ContentType.JSON)
                .body(getGeneratedString("modify-user-datatpe2-invalid.json"))
                .when()
                .put(modifyEndPoint)
                .then()
                .assertThat().statusCode(400)
