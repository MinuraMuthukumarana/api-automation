...
public class GenericRestController extends BaseClass {
    ...
    public void saveValidTest() throws IOException {
        ...
        given()
                ...
                .queryParam("model", "AD")
                .body(getGeneratedString("generic-rest-save-valid.json"))
                .when()
                .post(saveEndPoint)
                .then()
    ...
    public void updateValidTest() throws IOException {
        ...
        given()
                ...
                .contentType(ContentType.JSON)
                .queryParam("model", "AD")
                .body(getGeneratedString("generic-rest-update-valid.json"))
                .when()
                .put(updateEndPoint)
                .then()
    ...
    public void deleteValidTest() throws IOException {
        ...
        given()
                ...
                .contentType(ContentType.JSON)
                .queryParam("model", "AD")
                .body(getGeneratedString("generic-rest-delete-valid.json"))
                .when()
